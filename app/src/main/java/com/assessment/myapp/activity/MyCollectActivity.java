...
import com.assessment.myapp.adapter.MyCollectAdapter;
...
import com.assessment.myapp.entity.MyCollectResponse;
...
//        mVideoView.setUrl(proxyUrl);
    ...
    private void getVideoList() {
        ...
        Api.config(ApiConfig.VIDEO_MYCOLLECT, params).getRequest(this, new AssessmentCallback() {
            @Override
