package com.assessment.myapp.adapter;
...
import com.assessment.myapp.entity.BaseResponse;
import com.assessment.myapp.entity.VideoEntity;
import com.assessment.myapp.listener.OnItemChildClickListener;
import com.assessment.myapp.listener.OnItemClickListener;
import com.assessment.myapp.view.CircleTransform;
...
//        vh.tvCollect.setText(String.valueOf(videoEntity.getCollectNum()));
    ...
    private void updateCount(int vid, int type, boolean flag) {
        ...
        Api.config(ApiConfig.VIDEO_UPDATE_COUNT, params).postRequest(mContext, new AssessmentCallback() {
            @Override
