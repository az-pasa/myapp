...
import com.assessment.myapp.activity.WebActivity;
import com.assessment.myapp.adapter.NewsAdapter;
...
import com.assessment.myapp.entity.NewsEntity;
import com.assessment.myapp.entity.NewsListResponse;
...
//                showToast("点击");
    ...
    private void getNewsList(final boolean isRefresh) {
        ...
        Api.config(ApiConfig.NEWS_LIST, params).getRequest(getActivity(), new AssessmentCallback() {
            @Override
