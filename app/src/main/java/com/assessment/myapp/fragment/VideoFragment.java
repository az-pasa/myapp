...
import com.assessment.myapp.adapter.VideoAdapter;
...
import com.assessment.myapp.entity.VideoListResponse;
import com.assessment.myapp.listener.OnItemChildClickListener;
import com.assessment.myapp.util.Tag;
import com.assessment.myapp.util.Utils;
...
//        mVideoView.setUrl(proxyUrl);
    ...
    private void getVideoList(final boolean isRefresh) {
        ...
        Api.config(ApiConfig.VIDEO_LIST_BY_CATEGORY, params).getRequest(getActivity(), new AssessmentCallback() {
            @Override
